...
async function handleCreateRace() {
	try {
		...
		console.error(`An error occurred while handling create race: ${error}`)
	}
}
...
function runRace(raceID) {
	...
	.catch((error) => {
		console.log(`An error occurred while executing the runRace method: ${error}`)
	})
}
...
function handleSelectPodRacer(target) {
	try {
		...
		console.log(`An error occurred while executing the function handleSelectPodRacer: ${error}`)
	}
}
...
function handleSelectTrack(target) {
	try {
		...
		console.error(`An error occurred while handling select track: ${error}`)
	}
}
...
function handleAccelerate() {
	try {
		...
		console.error(`An error occurred while handling accelerate request: ${error}`)
	}
}
...
function getTracks() {
	...
	.catch(error => console.error(`An error occured while getting tracks: ${error}`))
}
...
function getRacers() {
	...
	.then(response => response.json())
	.catch(error => console.error(`An error occured while getting racers: ${error}`))
}
